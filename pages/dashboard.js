                                ...
                                <div className="card overflow-hidden">
                                    <div className="card-header border-0 pb-0">
                                        <div className="mr-auto">
                                            <h2 className="text-black mb-2 font-w600">$65,123</h2>
                                            <p className="mb-1 fs-13">
                                                <svg width="21" height="15" viewBox="0 0 21 15" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                    <path d="M1 13.5C1.91797 12.4157 4.89728 9.22772 6.5 7.5L12.5 10.5L19.5 1.5" stroke="#2BC155" strokeWidth="2" />
                                                    ...
                                                    <defs>
                                                        <linearGradient x1="10.25" y1="3" x2="11" y2="13.5" gradientUnits="userSpaceOnUse">
                                                            <stop stopColor="#2BC155" offset="1" stopOpacity="0.73" />
                                ...
                                <div className="card">
                                    <div className="card-header border-0">
                                        ...
                                        <div className="dropdown custom-dropdown mb-0">
                                            <div className="btn sharp btn-primary tp-btn" data-toggle="dropdown">
                                    ...
                                    <div className="card-body p-0">
                                        <div className="dropdown custom-dropdown d-block">
                                            <div className="btn bgl-light d-flex align-items-center rounded-0 svg-btn " data-toggle="dropdown">
                                                ...
                                                <div className="text-left ml-3">
                                                    <span className="d-block fs-16 text-black">Ethereum</span>
                                                </div>
                                    ...
                                    <div className="card-body p-0">
                                        <div className="dropdown custom-dropdown d-block">
                                            <div className="btn bgl-light d-flex align-items-center rounded-0 svg-btn " data-toggle="dropdown">
                                                ...
                                                <div className="text-left ml-3">
                                                    <span className="d-block fs-16 text-black">Ripple</span>
                                                </div>
                                                <i className="fa fa-angle-down scale5 ml-auto"></i>
                                            </div>
                                            <div className="dropdown-menu dropdown-menu-right">
                                ...
                                <div className="card">
                                    <div className="card-header border-0 pb-0 d-block d-md-flex">
                                        ...
                                        <div className="dropdown custom-dropdown d-block mt-3 mt-sm-0">
                                            <div className="btn bgl-light d-flex align-items-center rounded-0 svg-btn btn-md" data-toggle="dropdown">
                                                <i className="fa fa-angle-down scale5 mr-3"></i>
                                                <div className="text-left ml-3">
                                                    <span className="d-block fs-16 text-black">561,511 Btc</span>
                                                </div>
                                        ...
                                        <div className="basic-form">
                                            <form>
                                                ...
                                                <div className="form-group">
                                                    <div className="input-group input-group-lg">
                                                        <div className="input-group-prepend">
                                                            <span className="input-group-text bg-white border  rounded-0">Price BPL</span>
                                                        </div>
                                                        <input type="number" className="form-control rounded-0" placeholder="0,000000" />
                                                    </div>
                                                </div>
                                                <div className="form-group">
                                                    <div className="input-group input-group-lg">
                                                        <div className="input-group-prepend">
                                                            <span className="input-group-text bg-white border rounded-0">Fee (1%)</span>
                                                        </div>
                                                        <input type="number" className="form-control rounded-0" placeholder="0,000000" />
                                                    </div>
                                                </div>
                                                <div className="form-group">
                                                    <div className="input-group input-group-lg">
                                                        <div className="input-group-prepend">
                                                            <span className="input-group-text bg-white border rounded-0">Total BPL</span>
                                                        </div>
                                                        <input type="number" className="form-control rounded-0" placeholder="0,000000" />
                                                    </div>
                                                </div>
